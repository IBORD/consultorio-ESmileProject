...
class DentistaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dentistum" do
    assert_difference("Dentistum.count") do
      post dentista_url, params: { dentistum: { endereco: @dentistum.endereco, especialidade: @dentistum.especialidade, nome: @dentistum.nome, telefone: @dentistum.telefone } }
    end
  ...
  test "should update dentistum" do
    patch dentistum_url(@dentistum), params: { dentistum: { endereco: @dentistum.endereco, especialidade: @dentistum.especialidade, nome: @dentistum.nome, telefone: @dentistum.telefone } }
